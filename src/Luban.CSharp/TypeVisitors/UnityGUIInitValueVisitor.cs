...
public class UnityGUIInitValueVisitor : ITypeFuncVisitor<string>
{
    ...
    {
        return $"new {ConstStrings.ListTypeName}<LubanKeyValuePair<{type.KeyType.Apply(UnityGUIDeclaringTypeNameVisitor.Ins)},{type.ValueType.Apply(UnityGUIDeclaringTypeNameVisitor.Ins)}>>()";
    }
}
